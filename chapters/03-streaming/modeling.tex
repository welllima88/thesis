...
% oder "Hossfeld" so wie in den References?
...
% Hä? Die playback strategies kommen dann doch weiter unten (null, threshold ...). Diese Liste sind die degrees of freedom!
...
% "need to" und "buffer drains" ergänzt, weil ein pathologischer Streamer ja absichtlich nach jedem Frame beliebig stallen könnte, und somit die Null Strategy "überträfe".
...
% Versteh ich nicht. Die mir bekannten Hysteresen funktionieren mit zwei Umschaltpunkten tadellos.
...
% "not" streichen oder durch "only" ersetzen, wie mir scheint.
...
%... aber die "Adaptive Streaming Strategies" nicht sehr detailliert.
...
% Based on work by Ákos Lukovics AFAIR. A person to acknowledge!
